                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <div className="flex flex-col gap-1 mt-1">
                            {revenues.length === 0 && (
                                <span className="text-lg text-gray-400">No revenue data</span>
                            )}
                            {revenues.map((r) => (
                                <span key={r.currency} className="text-3xl font-bold text-gray-900 tracking-tight">
                                    {r.currency} {parseFloat(r.total).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                </span>
                            ))}
                        </div>
                    </div>
